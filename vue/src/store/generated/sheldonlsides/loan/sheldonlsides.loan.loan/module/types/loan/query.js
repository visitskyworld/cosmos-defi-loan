...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.loan.loan.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Loan(request) {
        const data = QueryGetLoanRequest.encode(request).finish();
        const promise = this.rpc.request("sheldonlsides.loan.loan.Query", "Loan", data);
        return promise.then((data) => QueryGetLoanResponse.decode(new Reader(data)));
    }
    LoanAll(request) {
        const data = QueryAllLoanRequest.encode(request).finish();
        const promise = this.rpc.request("sheldonlsides.loan.loan.Query", "LoanAll", data);
