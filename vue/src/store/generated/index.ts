...
import SheldonlsidesLoanSheldonlsidesLoanLoan from './sheldonlsides/loan/sheldonlsides.loan.loan'
...
export default { 
  ...
  SheldonlsidesLoanSheldonlsidesLoanLoan: load(SheldonlsidesLoanSheldonlsidesLoanLoan, 'sheldonlsides.loan.loan'),
